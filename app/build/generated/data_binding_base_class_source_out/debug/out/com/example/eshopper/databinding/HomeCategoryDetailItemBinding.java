...
public final class HomeCategoryDetailItemBinding implements ViewBinding {
  @NonNull
  ...
  private HomeCategoryDetailItemBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static HomeCategoryDetailItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HomeCategoryDetailItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.home_category_detail_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HomeCategoryDetailItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HomeCategoryDetailItemBinding((RelativeLayout) rootView, imageProduct, nameProduct,
          priceProduct);
    }
