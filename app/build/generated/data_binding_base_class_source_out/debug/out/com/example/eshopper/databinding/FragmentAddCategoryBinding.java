...
public final class FragmentAddCategoryBinding implements ViewBinding {
  ...
  private FragmentAddCategoryBinding(@NonNull RelativeLayout rootView,
  ...
  public static FragmentAddCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddCategoryBinding((RelativeLayout) rootView, btnAddCategory, categoryName,
          categoryTitle, imagaCategory, imageBack, layoutEmail, layoutHeader);
    }
