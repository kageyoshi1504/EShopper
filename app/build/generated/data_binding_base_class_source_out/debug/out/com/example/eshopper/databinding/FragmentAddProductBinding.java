...
public final class FragmentAddProductBinding implements ViewBinding {
  ...
  private FragmentAddProductBinding(@NonNull RelativeLayout rootView,
  ...
  public static FragmentAddProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddProductBinding((RelativeLayout) rootView, amountProduct, btnCategory,
          descProduct, imageAdd, imageBack, imageLoad, imageProduct, layoutHead, layoutHeader,
          layoutInfo, nameProductEt, priceEt, productTitle, typeProduct);
    }
