...
public final class HomeProductListItemBinding implements ViewBinding {
  @NonNull
  ...
  private HomeProductListItemBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static HomeProductListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HomeProductListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.home_product_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HomeProductListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HomeProductListItemBinding((RelativeLayout) rootView, imageProduct, nameProduct,
          priceProduct);
    }
