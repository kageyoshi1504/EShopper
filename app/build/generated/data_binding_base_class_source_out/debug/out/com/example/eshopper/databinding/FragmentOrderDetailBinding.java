...
public final class FragmentOrderDetailBinding implements ViewBinding {
  ...
  private FragmentOrderDetailBinding(@NonNull RelativeLayout rootView,
      @NonNull RecyclerView rvOrderDetail) {
  ...
  public static FragmentOrderDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOrderDetailBinding((RelativeLayout) rootView, rvOrderDetail);
    }
