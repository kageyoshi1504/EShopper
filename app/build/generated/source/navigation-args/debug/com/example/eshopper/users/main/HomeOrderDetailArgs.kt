...
public data class HomeOrderDetailArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HomeOrderDetailArgs {
      bundle.setClassLoader(HomeOrderDetailArgs::class.java.classLoader)
      val __uid : String?
      ...
      return HomeOrderDetailArgs(__uid)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HomeOrderDetailArgs {
      val __uid : String?
