...
public data class HomeProductDetailFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HomeProductDetailFragmentArgs {
      bundle.setClassLoader(HomeProductDetailFragmentArgs::class.java.classLoader)
      val __itemId : String?
      ...
      return HomeProductDetailFragmentArgs(__itemId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        HomeProductDetailFragmentArgs {
      val __itemId : String?
